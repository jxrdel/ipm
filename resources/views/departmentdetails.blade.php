...
@section('title')
    <title>
        ICT Contracts | Department Details</title>
@endsection
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col" style="text-align: end">
            ...
            <a href="{{ route('listdepartments') }}" class="btn btn-outline-secondary" style="width: 8rem">Return to
                List</a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row" style="padding-top: 20px">
                ...
                <div class="col">Active: <i
                        class="{{ $department->IsActive == 1 ? 'bi bi-check-lg' : 'bi bi-x-lg' }}"></i></div>
            </div>
        </div>
    </div>
