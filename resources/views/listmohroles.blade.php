        ...
        <div class="card">
            <div class="card-body">
                @auth
                    ...
                    @else
                        <button disabled class="btn btn-primary btn-icon-split" style="width: 9rem;pointer-events: auto;cursor: not-allowed;" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Access denied">
                            <span class="icon text-white-50">
                                <i class="fas fa-plus" style="color: white"></i>
                            </span>
                            <span class="text"  style="width: 200px">Add Role</span>
...
@section('scripts')
    ...
    <script>
        function showEdit(roleid) {
            ...
            if (hasPermission == 1){
                Livewire.dispatch('show-edit-modal', { roleid: roleid });
            } else {
