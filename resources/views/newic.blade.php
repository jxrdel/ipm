...
@section('title')
    <title>ICT Contracts | Create Employee Contact</title>
@endsection
    ...
    <form method="POST" id="updateUser" action="{{ route('createic') }}">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <div class="form-floating mb-3">
                            <input name="FirstName" type="text" class="form-control" id="floatingInput"
                                placeholder="FirstName" style="color: black" required>
                    ...
                    <div class="col">
                        <div class="form-floating mb-3">
                            <input name="LastName" type="text" class="form-control" id="floatingInput"
                                placeholder="LastName" style="color: black" required>
                ...
                <div class="row">
                    ...
                    <div class="col" style="display: flex">
                        ...
                        <input class="form-control" name="Email" type="email" name="" required
                            style="width: 300px">
                    </div>
        ...
        <div class="row" style="padding-top: 10px; padding-bottom:30px;">
            <div class="col">
                ...
                <a href="{{ route('listinternalcontacts') }}" class="btn btn-outline-secondary"
