...
@section('title')
    <title>ICT Contracts | Create User</title>
@endsection
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4" style="display: flex">
                                ...
                                <input class="form-control" name="username" type="text" name="" style="width: 60%"
                                    required autocomplete="off">
                            </div>

                            <div class="col-2">
                                <label for="IsActive">Active:&nbsp;</label>
                                <input class="form-check-input" type="checkbox" name="IsActive" style="margin-left: 15px"
                                    checked>
                            ...
                            <div class="col">
                                <div style="margin-top: -6px;display:flex">
                                    ...
                                    <select name="InternalContactId" class="form-select"
                                        style="display: inline;width: 300px">
                                        <option value=""></option>

                                        @foreach ($internalcontacts as $internalcontact)
                                            <option value="{{ $internalcontact->ID }}">{{ $internalcontact->FirstName }}
                                                {{ $internalcontact->LastName }}</option>
                                        @endforeach
