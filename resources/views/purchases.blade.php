...
@section('title')
    <title>ICT Contracts | Purchases</title>
@endsection
            ...
            <div class="row" style="margin-left: 5px">
                ...
                @auth
                    @if (auth()->user()->hasPermission('ExternalPurchase : Create : Screen'))
                        <a type="button" data-bs-toggle="modal" data-bs-target="#createPurchaseModal"
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#purchasetable').DataTable({
                ...
                "columns": [{
                    ...
                    {
                        data: 'CompanyName',
                        name: 'ExternalContactCompanies.CompanyName'
                    },
                    {
                        data: 'PTypeName',
                        name: 'ExternalPurchaseTypes.Name'
                    },
                    {
                        data: null,
                        orderable: false,
        ...
        function showView(id) {
            Livewire.dispatch('show-viewpurchase-modal', {
                id: id
            });
        }
        ...
        function showEdit(id) {
            ...
            if (hasPermission == 1) {
                Livewire.dispatch('show-editpurchase-modal', {
                    id: id
                });
            } else {
