...
@section('title')
    <title>ICT Contracts | User Details</title>
@endsection
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col">Active: <i class="{{ $user->IsActive == 1 ? 'bi bi-check-lg' : 'bi bi-x-lg' }}"></i>
                </div>
                <div class="col">System Admin: <i
                        class="{{ $user->IsSysAdmin == 1 ? 'bi bi-check-lg' : 'bi bi-x-lg' }}"></i></div>
            </div>
            <div class="row" style="padding-top: 10px">
                <div class="col">Contact: <a href="#"
                        onclick="displayIC({{ $internalcontact->ID }})">{{ $internalcontact->FirstName }}
                        {{ $internalcontact->LastName }}</a></div>
            </div>
        </div>
    </div>
